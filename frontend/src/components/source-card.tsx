    ...
    >
      ...
      {onRemove && (
        <button
          ...
          className="shrink-0 rounded-md p-1 text-muted-foreground opacity-0 transition-opacity hover:bg-muted hover:text-foreground group-hover/source:opacity-100"
        >
